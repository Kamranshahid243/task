                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?= $gen->titlePlural() ?></h3>
                            <a href="{{ url('/admin/<?= $gen->route() ?>/create') }}" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> <span>Create <?= $gen->titleSingular() ?></span></a>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">

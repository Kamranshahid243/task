        ...
        <div class="col-md-4">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Edit State Level Pricing</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-verticle form" method="post" action="{{ url('/admin/states/pricings/'.$editablePricing->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                            ...
                            <select class="form-control select2 country-list" name="country_id" placeholder="">
                                ...
                                @if( $countries->count() )
                                    ...
                                    @foreach( $countries as $country)
                                        @if( $editablePricing->country->id == $country->id )
                            ...
                            <select class="form-control select2 state-list" name="state_id" placeholder="">
                                @if( $states->count() )
                                    ...
                                    @foreach( $states as $state)
                                        @if( $state->name == $editablePricing->name )

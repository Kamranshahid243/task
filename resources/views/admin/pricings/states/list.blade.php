...
<div class="content-wrapper" style="min-height: 1126px;">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Create State Level Pricing</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-verticle form" method="post" action="{{ url('/admin/states/pricings') }}">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group states-wrapper">
                            <label class="">Select one or more states<span class="text-red">*</span></label>
                            <select class="form-control select2 state-list" name="states[]" multiple placeholder="">
                               <option value="">--select--</option>
                            </select>
                            <span><em>You can select multiple states to set the same price</em></span>
                        </div>
                        <div class="form-group">
        ...
        <div class="col-md-8">
            <div class="box box-primary ">
                <div class="box-header with-border">
                    <h3 class="box-title">View All States Pricings</h3>
                </div>
                <div class="box-body">
                        ...
                        @if( isset( $pricings ) and $pricings->count() )
                            @foreach( $pricings as $pricing )
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/admin/states/pricings/'.$pricing->id.'/edit') }}"  title="Edit" data-action="edit" class="btn btn-xs btn-default"><i class="fa fa-edit"></i></a> 
                                        <a href="#" data-type="admin" data-id="{{ $pricing->id }}" data-url="/admin/states/pricings/{{$pricing->id}}"  title="Delete"data-action="delete" class="custom-table-btn btn btn-xs btn-default"><i class="fa fa-trash-o"></i></a>

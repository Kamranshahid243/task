        ...
        <div class="col-md-4">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Create Country Level Pricing</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-verticle form" method="post" action="{{ url('/admin/countries/pricings') }}">
                    @csrf
                    <div class="box-body">
                        <div class="form-group">
                            <label class="">Select one or more countries<span class="text-red">*</span></label>
                            <select class="form-control select2" name="countries[]" multiple placeholder="safas">
                                @if( $countries->count() )
                        ...
                        @if( isset( $pricings ) and $pricings->count() )
                            @foreach( $pricings as $pricing )
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/admin/countries/pricings/'.$pricing->id.'/edit') }}"  title="Edit" data-action="edit" class="btn btn-xs btn-default"><i class="fa fa-edit"></i></a> 

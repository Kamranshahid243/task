    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-verticle form" method="post" action="{{ url('/admin/faqs/management/'.$faq->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control auc-editor" name="answer" placeholder="Answer">{{ $faq->answer }}</textarea>
                        </div>

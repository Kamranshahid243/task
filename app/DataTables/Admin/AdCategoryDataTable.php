...
class AdCategoryDataTable extends DataTable
{
    /**
        ...
        return datatables( $query )
            ...
            ->addColumn('thumbnail', function( $query ){
                if($query->thumbnail){
                    ...
                    $dom .= '<a href="'.url('/admin/ad-categories/'.$query->id).'" class="pull-left">'.$query->name;
                    $dom .= '</h2>';
                    return $dom;
                }
                return 'N/A';
            ...
            ->addColumn('action', function( $query ){
                $links  = '<a href="'. url('/admin/ad-categories/'.$query->id) .'" data-toggle="tooltip" data-placement="top" title="View" data-action="view" class="btn btn-xs btn-default" data-original-title="Edit"><i class="fa fa-eye"></i></a>';
            ...
            ->rawColumns(['id','nickname',  'name', 'thumbnail', 'title', 'description', 'created_by', 'is_paused']);
    }
     ...
     */
    public function query(AdCategory $model)
    {

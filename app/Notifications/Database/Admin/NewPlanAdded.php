...
class NewPlanAdded extends Notification
{
    use Queueable;
    private $admin;
    private $message;
    ...
    public function __construct( $plan, $superadmin, $nofityType )
    {
        ...
        if( $nofityType == 'self-notify' ){
            ...
            $this->message          = 'You added new plan';
            $this->icon             = 'fa fa-newspaper-o text-purple';
            $this->timelineIcon     = 'fa fa-newspaper-o bg-purple';
           
        }
        else{
            $this->message          = '<a href="/admin/users/management/'.$superadmin->id.'">'.$superadmin->first_name.' '.$superadmin->last_name.'</a> added new plan';
            $this->icon             = 'fa fa-newspaper-o text-purple';
            $this->timelineIcon     = 'fa fa-newspaper-o bg-purple';
        }

...
class FaqUpdated extends Notification
{
    use Queueable;
    private $admin;
    private $message;
    ...
    public function __construct( $faq, $superadmin, $nofityType )
    {
        ...
        if( $nofityType == 'self-notify' ){
            ...
            $this->message          = 'You updated faq';
            $this->icon             = 'fa fa-question-circle text-blue';
            $this->timelineIcon     = 'fa fa-question-circle bg-blue';
           
        }
        else{
            $this->message          = '<a href="/admin/users/management/'.$superadmin->id.'">'.$superadmin->first_name.' '.$superadmin->last_name.'</a> updated faq';
            $this->icon             = 'fa fa-question-circle text-blue';
            $this->timelineIcon     = 'fa fa-question-circle bg-blue';
        }

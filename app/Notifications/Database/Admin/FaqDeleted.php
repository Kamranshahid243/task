...
class FaqDeleted extends Notification
{
    use Queueable;
    private $admin;
    private $message;
    ...
    public function __construct( $faq, $superadmin, $nofityType )
    {
        ...
        if( $nofityType == 'self-notify' ){
            ...
            $this->message          = 'You deleted faq';
            $this->icon             = 'fa fa-question-circle text-red';
            $this->timelineIcon     = 'fa fa-question-circle bg-red';
           
        }
        else{
            $this->message          = '<a href="/admin/users/management/'.$superadmin->id.'">'.$superadmin->first_name.' '.$superadmin->last_name.'</a> deleted faq';
            $this->icon             = 'fa fa-question-circle text-red';
            $this->timelineIcon     = 'fa fa-question-circle bg-red';
        }

...
class PlanUpdated extends Notification
{
    use Queueable;
    private $admin;
    private $message;
    ...
    public function __construct( $plan, $superadmin, $nofityType )
    {
        ...
        if( $nofityType == 'self-notify' ){
            ...
            $this->message          = 'You updated plan';
            $this->icon             = 'fa fa-newspaper-o text-purple';
            $this->timelineIcon     = 'fa fa-newspaper-o bg-purple';
           
        }
        else{
            $this->message          = '<a href="/admin/users/management/'.$superadmin->id.'">'.$superadmin->first_name.' '.$superadmin->last_name.'</a> updated plan';
            $this->icon             = 'fa fa-newspaper-o text-purple';
            $this->timelineIcon     = 'fa fa-newspaper-o bg-purple';
        }
